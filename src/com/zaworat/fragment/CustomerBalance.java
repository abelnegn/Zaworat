...
public class CustomerBalance extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.customer_balance, container, false);
        ...
        btnGenerateReport.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				try {
					...
					rowHeader = "<tr bgcolor='#FAAFC0'> <td bgcolor='#FAAFC0' scope='row'> <b> Customer Name </b></td> <td bgcolor='#FAAFC0' scope='row'> <b> Amount </b> </td>  </tr>";
					tableTitleHTMLRow = "<tr bgcolor='#FFAACC'>  <th colspan='2' bgcolor='#FFAACC' scope='row'> <strong>Customer Balance Report</strong> </th>  </tr>";									    	
					cursor.moveToFirst();
					for(int cur = 0; cur < cursor.getCount(); cur++){
					    if (cursor != null) {
						      String sBranch = cursor.getString(cursor.getColumnIndexOrThrow("cust_name"));
	...
	public Cursor getGroupQuery(Date dateFrom , Date dateTo){
		...
		String selectQuery = "SELECT customer_Name cust_name, sum(amount) amount " +
				"FROM Customer_Balance WHERE balance_Date between ? and ? " +
